...
String lessonid = service
    .less.requiredLesson!.questions!.practiceQuestions![service.num].sId
    .toString();
...
class _QuestionScreen2State extends State<QuestionScreen2> {
  late List<bool> pressedAttentions =
      service.options[service.num].map((e) => false).toList();
  int? tappedIndex;
  @override
  void initState() {
    super.initState();
                                          ...
                                          SizedBox(
                                            ...
                                            child: RaisedButton(onPressed: () {answer(
                                                      ...
                                                      update(qid, '${((service.step/
                                                          service.total)*100).toInt()}');  },child: Text('SUBMIT',style:TextStyle(color: white1),),color: Colors.black,),
                                          ),
                                      ],
                                    )
                                    : ListView.builder(
