...
import 'depression_final_score .dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'package:archna_frontend/models/whatdepmean.dart';
import 'depression_final_score .dart';
...
class _Depression1State extends State<Depression1> {
  Future<What_depmean> what_mean(String score) async {
    ...
    if (response.statusCode == 200) {
      ...
      print(response.body);
      _whatdepmodel = What_depmean.fromJson(jsonDecode(response.body));
      service.problem = _whatdepmodel.depressionSeverity.toString();
      service.solution = _whatdepmodel.proposedTreatment.toString();
      prefs.setString(
          'depressionSeverity', _whatdepmodel.depressionSeverity.toString());
      prefs.setString(
          'proposedTreatment', _whatdepmodel.proposedTreatment.toString());
      return What_depmean.fromJson(jsonDecode(response.body));
    } else {
        ...
        body: Column(
          ...
          children: [
            ...
            Text.rich(TextSpan(children: [
              TextSpan(text: score.toString(), style: text4),
              TextSpan(
                  text: '  out of 63',
                  style: TextStyle(
