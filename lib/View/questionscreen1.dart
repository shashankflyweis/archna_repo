...
String lessonid = service
    .less.requiredLesson!.questions!.testUnderstandingQuestions![service.num].sId
    .toString();
                          ...
                          onTap: () {
                            ...
                            if (service.num ==
                                (service.less.requiredLesson!.questions!
                                        .testUnderstandingQuestions!.length
                                        .toInt() -
                                    1)) {
                              Get.to(() => LessonSummery());
                            } else {
                              service.num++;
                              print(service.num);
                    ...
                    child: Text.rich(
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "/${service.less.requiredLesson!.questions!.testUnderstandingQuestions!.length}",
                            style: Theme.of(context)
                                .textTheme
                                .headline6!
                                .copyWith(color: Colors.black),
