...
class UnderStandingController extends GetxController
    with StateMixin<UnderStandingModel1> {
  ...
  List<UnderStandingModel1> _questions = underStandindData
      .map(
        (question) => UnderStandingModel1(
          id: question['id'],
      ...
      .toList();
  List<UnderStandingModel1> get questions => _questions;
  ...
  void checkAns(UnderStandingModel1 question, int selectedIndex) {
  ...
  void nextQuestion() {
    if (_questionNumber.value != _questions.length) {
      ...
      Get.delete<UnderStandingController>();

      // Get package provide us simple way to naviigate another page
      Get.to(() => LessonSummery(), arguments: 80);
    }
  }
